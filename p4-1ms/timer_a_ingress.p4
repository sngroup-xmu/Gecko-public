    ...
    inout ingress_intrinsic_metadata_for_tm_t        ig_tm_md)
{
    ...
    table table_send_to_somewhere{
        ...
        const entries = {
            ...
            ( 20,0)  :  action_send_to_client();
            (900,0)  :  action_send_to_client();
            ( 34,0)  :  action_send_to_client();//action_send_to_client
            ( 35,0)  :  action_send_to_client();//action_send_to_master
            ...
            ( 70,1)  :  action_send_to_CS_1();
            ( 70,2)  :  action_send_to_CS_2();
            ( 70,3)  :  action_send_to_CS_3();
            ( 70,4)  :  action_send_to_CS_4();
            ( 70,10) :  action_send_to_CS();
        }
        const default_action = no_action();
        size = 30;
    }
